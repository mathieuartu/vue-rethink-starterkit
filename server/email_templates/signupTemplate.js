export const signupTemplate = info => `<!DOCTYPE html
          ...
          <tr>
            <td align="center" valign="top">
              ...
              <table class="container hero-subheader" border="0" cellpadding="0" cellspacing="0" width="620"
                style="width: 620px;">
                <tr>
                  <td class="hero-subheader__title" style="font-size: 24px; font-weight: bold; padding: 80px 0 15px 0;"
                    align="left">⚡️${info.username}, bienvenue sur ${info.siteName} ⚡️</td>
                </tr>

                <tr>
                  <td class="hero-subheader__content"
                    style="font-size: 16px; line-height: 27px; color: #969696; padding: 0 60px 90px 0;" align="left">Nous sommes heureux de t'accueillir parmi nous 😸</td>
                </tr>
              </table>
              <!-- /// Hero subheader -->
            </td>
